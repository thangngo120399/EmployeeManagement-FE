...
import FresherUpdate from "./components/Candidates/Freshers/Update/Update";
import InternUpdate from "./components/Candidates/Interns/Update/Update";
import ExperienceUpdate from "./components/Candidates/Experiences/Update/Update";
import CandidateUpdate from "./components/Candidates/CandidateUpdate/Update";
const App = () => {
        ...
        <div id="content">
          ...
          <div className="container mt-3">
            <Switch>
              ...
              <Route path="/fresher/profile/:id" component={InternUpdate} />
              <Route path="/experience/profile/:id" component={InternUpdate} />
              <Route
