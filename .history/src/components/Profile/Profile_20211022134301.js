...
function Profile(props) {
  ...
  const [academicLevelsObj, setAcademicLevelsObj] = useState([]);
  const departments = [];
  ...
  useEffect(() => {
    DepartmentService.getAll().then(
      (response) => {
        setDepartmentsObj(response.data);
        departmentsObj.map((item) => {
          departments.push({ value: item.id, label: item.name });
        });
      },
      (error) => {
        const _content =
  ...
  //     (response) => {
  //       setPositionsObj(response.data);
  //       console.log(positionsObj);
  //       // positionsObj.map((item, index) =>
  //       //   positions.push({ value: item.id, label: item.name })
  //       // );
  //     },
  //     (error) => {
  //       const _content =
  ...
  useEffect(() => {
    AcademicLevelService.getAll().then(
      (response) => {
        setAcademicLevelsObj(response.data);
        academicLevelsObj.map((item) => {
          academicLevels.push({ value: item.id, label: item.name });
        });
      },
      (error) => {
        const _content =
  ...
  useEffect(() => {
    ...
    PositionService.getAll().then(
      (response) => {
        ...
        response.data.map(
          // (item, index) => console.log(item.namePosition + item.id)
          (positions = [
            ...positions,
            { value: item.id, label: item.namePosition },
          ])
