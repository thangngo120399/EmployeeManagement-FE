...
const createFresher = (
  ...
  console.log(
    fullName + dob + phone + email + education + graduationDate + graduationRank
  );
...
const createExperience = (fullName, dob, phone, email, experInYear, skills) => {
  console.log(fullName + dob + phone + email + experInYear + skills);
